defmodule MissionControlWeb.UserLiveTest do
  use MissionControlWeb.ConnCase

  import Phoenix.LiveViewTest

  alias MissionControl.Accounts

  @create_attrs %{email: "some@email.com", username: "some username"}
  @save_attrs %{email: "other@email.com", username: "some other username"}
  @update_attrs %{email: "some_updated_email@mail.com", username: "some updated username"}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some_updated_email@mail.com"
    end
